 ...
 */
async function getNewTokenWithServer(oAuth2Client: OAuth2Client): Promise<OAuth2Client> {
 ...
 */
async function getNewTokenManual(oAuth2Client: OAuth2Client): Promise<OAuth2Client> {
